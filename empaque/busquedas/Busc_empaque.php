...
<html>
		...
		<div class="contenedor-form">
	  		...
	  		<div class="modal-header">
	    		<h3 class="modal-title">
	    			<img class="img-header" src="img/empaque.png"> Búsqueda de empaques
	    		</h3>
	  		</div>
	...
	<div class="busqueda-form">
				<div class="form-group">
			    	...
			    	<div class="col-sm-10">
			      		<input onkeyup="if(event.keyCode == 13) buscar();" type="text" class="form-control" id="inputBuscar" placeholder="Buscar empaque">
			    	</div>
			  	</div>
		</div>
