...
<html>
	...
	<body>
		<?php 
			...
			$placeholder="Nombre del empaque / RFC / ID";
			$imagen = "empaque.png";
	...
	<script type="text/javascript">
		...
		function aplicar(){
			...
			if($("#status").val() == 0 || $("#status").val() == 1) 
				consulta = " AND estado_e = '" + $("#status").val() + "' " ;
			else consulta = "" ;
			...
			{
				case '0': break;
				case '1': consulta += " AND fecha_registro_emp < '"+$("#fecha_i").val()+"'";  break;
				case '2': consulta += " AND fecha_registro_emp = '"+$("#fecha_i").val()+"'";  break;
				case '3': consulta += " AND fecha_registro_emp > '"+$("#fecha_i").val()+"'";  break;
				case '4': consulta += " AND fecha_registro_emp > '"+$("#fecha_i").val()+"' AND fecha_registro_emp < '"+$("#fecha_f").val()+"'"; break;
			}
			//alert(consulta);
			$("#filtro").val(consulta);
			buscar();
