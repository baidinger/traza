...
<script type="text/javascript">
		...
		function aplicar(){
			...
			{
				case '0': break;
				case '1': consulta += " AND fecha_creacion_usuario < '"+$("#fecha_i").val()+"'";  break;
				case '2': consulta += " AND fecha_creacion_usuario = '"+$("#fecha_i").val()+"'";  break;
				case '3': consulta += " AND fecha_creacion_usuario > '"+$("#fecha_i").val()+"'";  break;
				case '4': consulta += " AND fecha_creacion_usuario > '"+$("#fecha_i").val()+"' AND fecha_creacion_usuario < '"+$("#fecha_f").val()+"'"; break;
			}
			//alert(consulta);
			$("#filtro").val(consulta);
			buscar();
