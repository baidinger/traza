...
<div class="modal-header">
		<h3 class="modal-title">
			<img class="img-header" src="img/empaque.png"> Registrar empaque
		</h3>
	</div>
     		...
     		<div class="modal-body" style="width:50%; float: left; border-radius: 5px">
	  		<div class="alert alert-info">DATOS DEL EMPRESA</div>
				...
				<!-- Estado -->
			  	...
			  	<hr>
			  	<center>
			  		<a href="index.php?op=bus_empaque" class="btn btn-default" data-dismiss="modal" style="width:150px">Atrás</a>
