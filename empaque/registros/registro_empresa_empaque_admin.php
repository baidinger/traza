	...
	if(mysql_query(" INSERT INTO usuarios (nombre_usuario,".
		...
		//echo "bien";
			...
			if(mysql_query("INSERT INTO empresa_empaques (nombre_empaque, rfc_empaque,".
				...
				" cp_empaque, email_empaque, telefono1_empaque, telefono2_empaque, id_usuario_que_registro) VALUES ".
				"('".$nombre."','".$rfc."','".$pais."','".$estado."','".$ciudad."','".$direccion."','".$cp."','".$email."','".$tel1."','".$tel2."',".$_SESSION['id_usuario'].")"))
			{
