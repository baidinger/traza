		...
		<table class="table">
			...
			<tbody>
				...
				if(isset($_POST['productor']))
					...
					$cont = 1;
				    $consulta = "SELECT * FROM productos WHERE nombre_producto LIKE '%$producto%' OR variedad_producto LIKE '%$producto%' ORDER BY nombre_producto ASC, variedad_producto ASC";
