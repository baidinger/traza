<?php 
	...
	$cadena = " INSERT INTO lotes (id_productor_fk, id_producto_fk, cant_cajas_lote, cant_kilos_lote, remitente_lote, fecha_recibo_lote, hora_recibo_lote, costo_lote, rango_inicial, rango_final, id_empaque_fk) 
		VALUES ($id_productor,$id_producto,$cantidad_cajas,$cantidad_kilos,'".$nombre_remitente."','".date("Y-m-d")."','".date("H:i:s")."',$costo_lote,'".$rango_inicial."','".$rango_final."',$id_empaque)";
