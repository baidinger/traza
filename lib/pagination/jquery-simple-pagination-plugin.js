	...
	*/
	...
	return this.each(function()
	{
		...
		function refresh_simple_pagination(page_number)
		{
			...
			{
				var page_x_of_x_html = '' + settings.page_x_of_x_content + ' ' + simple_number_formatter(page_number, 0, settings.thousands_separator) + ' de ' + simple_number_formatter(page_count, 0, settings.thousands_separator);
...
$.fn.simplePagination.defaults = {
	...
	//
	first_content: 'Inicio',  //e.g. '<<'
	previous_content: 'Ant',  //e.g. '<'
	next_content: 'Sig',  //e.g. '>'
	last_content: 'Fin', //e.g. '>>'
	page_x_of_x_content: 'Pág',
	showing_x_of_x_content: 'Viendo',
	//
